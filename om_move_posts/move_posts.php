			...
			<fieldset class="frm-group group<?php echo ++$forum_page['group_count'] ?>">
				<div class="sf-set set<?php echo ++$forum_page['item_count'] ?>">
					<div class="sf-box select">
						<label for="fld<?php echo ++$forum_page['fld_count'] ?>"><span><?php echo $lang_om_move_posts['Destination forum']?></span></label><br />
	...
	<div class="main-content main-frm">
		<form class="frm-form" method="post" accept-charset="utf-8" action="<?php echo $forum_page['form_action'] ?>">
			...
			<fieldset class="frm-group group<?php echo ++$forum_page['group_count'] ?>">
				<div class="sf-set set<?php echo ++$forum_page['item_count'] ?>">
					<div class="sf-box select">
						<label for="fld<?php echo ++$forum_page['fld_count'] ?>"><span><?php echo $lang_om_move_posts['Destination topic']?></span></label><br />
...
?>
				...
				<div class="sf-set set2">
					<div class="sf-box checkbox">
						...
						<label for="fld2"><span><?php echo $lang_om_move_posts['Ignore dates']?></span> <?php echo $lang_om_move_posts['Ignore text']?></label>
					</div>
				</div>
...
if (isset($_POST['move_posts_to']))
{
	...
	$query = array(
		'UPDATE'	=> 'posts',
		'SET'		=> 'topic_id='.$move_to_topic.', om_move_posts='.$om_move_posts_max,
